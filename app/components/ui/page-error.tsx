...
export function PageError({ error, reset }: PageErrorProps) {
  ...
  return (
    <div
      className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-base-200 p-4 animate-fadeIn"
      role="alert"
      aria-live="assertive"
    >
      <div className="card w-full max-w-md bg-base-100 shadow-xl border border-error/20">
        <div className="card-body items-center text-center gap-4 py-12">
          {/* Icon with themed pulsing background */}
          ...
          <p className="text-sm text-base-content/70 leading-relaxed max-w-sm mb-2">
          ...
          <div className="card-actions w-full mt-2">
            <button
              onClick={reset}
              className="btn btn-primary btn-block rounded-full shadow-md transition-all hover:scale-[1.02] active:scale-95 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            >
              {t('tryAgain')}
            </button>
          </div>

...
// Harvest Upload Schema (harvesting_mobile hanya butuh 3 key pencocokan)
export const harvestUploadSubmitSchema = z.object({
  data: z.array(
    z.object({
      spbno: z.string().min(1, 'SPBNO wajib diisi'),
      fieldcode: z.string().min(1, 'FIELDCODE wajib diisi'),
      harvestdate: z.string().min(1, 'HARVESTDATE wajib diisi'),
    })
